...
def add_default_hygiene(**kwargs):
    males_count = kwargs["males_count"]
    females_count = kwargs["females_count"]
    hygiene = [
        {"name": "Зубная щётка", "count": males_count + females_count}, {"name": "Зубная паста", "count": 1},
        {"name": "Гель для душа", "count": int(males_count > 0) + int(females_count > 0)},
        {"name": "Шампунь", "count": int(males_count > 0) + int(females_count > 0)},
        {"name": "Мочалка", "count": males_count + females_count},
        {"name": "Косметичка", "count": females_count}
    ]
    return hygiene
...
def build(request):
    ...
    result["hygiene/cosmetics"] = add_default_hygiene(
        males_count=males_count,
        females_count=females_count
    )
